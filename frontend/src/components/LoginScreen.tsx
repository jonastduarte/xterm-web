    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          background: 'linear-gradient(135deg, #005a9e, #3498db)', 
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          marginBottom: '16px', boxShadow: '0 4px 15px rgba(0, 90, 158, 0.3)'
        }}>
          <TerminalSquare size={28} color="#fff" />
        </div>
        
        <h2 style={{ margin: '0 0 4px 0', fontSize: '20px', fontWeight: '600', color: '#fff' }}>XTerm Web</h2>
        <p style={{ margin: '0 0 24px 0', fontSize: '12px', color: 'rgba(255,255,255,0.5)' }}>SSH • SFTP • FTP Client</p>
        
        {error && (
          <div style={{ 
            color: '#ff6b6b', fontSize: '12px', marginBottom: '12px', 
            backgroundColor: 'rgba(255, 107, 107, 0.1)', 
            padding: '8px 12px', borderRadius: '6px', width: '100%', textAlign: 'center',
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '14px', width: '100%' }}>
          ...
          <button 
            ...
            style={{ 
              padding: '11px', 
              background: loading ? '#555' : 'linear-gradient(135deg, #005a9e, #3498db)', 
              color: '#fff', border: 'none', borderRadius: '8px', 
              cursor: loading ? 'wait' : 'pointer', fontWeight: '600', 
              marginTop: '6px', fontSize: '14px',
              boxShadow: '0 4px 15px rgba(0, 90, 158, 0.3)',
              transition: 'all 0.2s'
            }}
          >
      ...
      <p style={{ marginTop: '24px', fontSize: '11px', color: 'rgba(255,255,255,0.25)' }}>
        XTerm Web v1.0 — Remote Connection Manager
      </p>
    </div>
  );
};
